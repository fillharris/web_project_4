...
const addProfileFormValidator = new _components_FormValidator_js__WEBPACK_IMPORTED_MODULE_2__.FormValidator(settings, editProfileForm);
addProfileFormValidator.enableValidator();
const addImageFormValidator = new _components_FormValidator_js__WEBPACK_IMPORTED_MODULE_2__.FormValidator(settings, addCardForm);
addImageFormValidator.enableValidator();
const editAvatarFormValidator = new _components_FormValidator_js__WEBPACK_IMPORTED_MODULE_2__.FormValidator(settings, editAvatarForm);
